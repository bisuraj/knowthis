                    ...
                    <form method="POST" class="register-form" id="signup-form">
                        <div class="card-body p-5 text-black">
                            <div class="my-md-2">
                                ...
                                <div class="form-outline form-black mb-4">
                                    <input type="password" id="typeConfirmPassword"
                                ...
                                <div class="form-check form-switch mb-4">
                                    <input class="form-check-input" type="radio" name="userTypeRadio" id="ruralRadio"
                                        value="rural" checked>
                                    <label class="form-check-label" for="ruralRadio">Rural User</label>
                                </div>
                                <div class="form-check form-switch mb-4">
                                    <input class="form-check-input" type="radio" name="userTypeRadio"
                                        id="professionalRadio" value="professional">
